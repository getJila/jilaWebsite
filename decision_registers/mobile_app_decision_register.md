...
- Decision register index (platform split): `./00_index.md`
- **Mobile PRD**: `../pm/mobile_app/05_mobile_app_prd.md`
- **Mobile feature scope**: `../pm/mobile_app/03_feature_requirements_document.md`
- **Journeys + guardrails**: `../pm/mobile_app/02_user_journey_maps.md`
- **Offline baseline**: `../pm/mobile_app/07_offline_mode_and_sync_specification.md`
- **Notifications baseline**: `../pm/mobile_app/08_notification_and_alert_strategy.md`
- **Language/accessibility**: `../pm/mobile_app/09_localization_and_accessibility.md`
- **Inclusive design addendum**: `../pm/mobile_app/10_inclusive_design_guidelines.md`
...
- **Canonical design**: `docs/design/jila_design_decision_register.md` (Replenishment Card pattern decisions) and `docs/ux/jila_design_guide.md` (implementation guidance).
...
- **Canonical design**: `docs/design/jila_design_decision_register.md` (UX-D-036/037/038) and `docs/ux/jila_design_guide.md` (Offline-first Monitoring UI).
...
- **Canonical design**: `docs/ux/jila_design_guide.md` (Onboarding & education patterns) and `docs/design/jila_design_decision_register.md` (UX-D-032/044/047/048).
...
- **Status**: DECIDED
- **Decision**: Track design-system choices in a dedicated decision register: `docs/design/jila_design_decision_register.md`.
...
### MA-035 — date-fns for date/time (cross-platform alignment)
- **Status**: DECIDED (2026-01-14)
- **Decision (v1)**: date-fns for date/time manipulation (aligned with web portal WP-060).
- **Why it matters**: cross-platform consistency, tree-shakable, immutable API.

### MA-036 — Native fetch for HTTP (cross-platform alignment)
- **Status**: DECIDED (2026-01-14)
- **Decision (v1)**: Use React Native's native `fetch` API (no axios). TanStack Query handles caching/retry (aligned with web portal WP-033).
- **Why it matters**: smaller bundle, modern API, cross-platform consistency.

### MA-037 — Detox for E2E testing
- **Status**: DECIDED (2026-01-14)
- **Decision (v1)**: Detox for mobile E2E testing (web portal uses Playwright per WP-070).
- **Why it matters**: reliable E2E testing for React Native, grey-box testing approach.
