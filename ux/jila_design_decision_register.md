...
- Canonical design principles (cross-platform): `docs/ux/jila_canonical_design_principles.md`
- Decision register index (platform split): `docs/decision_registers/00_index.md`
- Mobile product decisions: `docs/pm/mobile_app/06_mobile_app_decision_register.md`
...
- **Decision (v1)**: Define a single, cross-platform theme and token contract that all product surfaces inherit.
  - **Canonical tokens (v1)**: `docs/ux/jila_theme_and_brand_tokens_v1.md` (this is the single source of truth)
...
- **Decision (v1)**: Use a consistent “Data vs. Narrative” typography contract across platforms.
  - **Canonical typography (v1)**: `docs/ux/jila_theme_and_brand_tokens_v1.md` (Typography section)
...
- **Decision (v1)**: Use a single spacing + radius scale across platforms (expressed as dp/px/rem as appropriate).
  - **Canonical spacing/radius (v1)**: `docs/ux/jila_theme_and_brand_tokens_v1.md` (Spacing + radius section)
